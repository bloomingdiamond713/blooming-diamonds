...
const Reviews = () => {
  ...
  console.log(reviews);
  return (
    <div id="reviews" className="mb-24 container py-10 relative">
      ...
      <TfiQuoteLeft className="text-9xl absolute -top-10 left-10 text-gray-300 -z-10" />
      <TfiQuoteRight className="text-9xl absolute -bottom-8 right-10 text-gray-300 -z-10" />
    </div>
  );
};
